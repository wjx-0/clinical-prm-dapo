...
TRAIN_FILES="${TRAIN_FILES:-${PROJECT_ROOT}/data/rl/medqa_train_stride2_5k/train.parquet}"
VAL_FILES="${VAL_FILES:-${PROJECT_ROOT}/data/rl/medqa_train_stride2_5k/val.parquet}"
REWARD_PATH="${REWARD_PATH:-${PROJECT_ROOT}/reward/total_reward.py}"
REWARD_PROFILE="${REWARD_PROFILE:-orm_v2}"
